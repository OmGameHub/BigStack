...
// @type    GET
// @route   /api/profile
// @desc    route for show user prrsonal info
// @access  PRIVATE
router.get(
    '/', 
...
// @type    POST
// @route   /api/profile
// @desc    route for update/saving user personal info
// @access  PRIVATE
router.post(
    '/',
    passport.authenticate('jwt', { session: false }), 
...
// @desc    route for getting user name profile based on USER ID
// @access  PUBLIC
router.get(
    '/user/:user_id', 
    (req, res) => {
...
// @desc    route for getting user name profile based on EVERYONE
// @access  PUBLIC
router.get(
    '/find/everyone', 
    (req, res) => {
        ...
        Profile.findOneAndRemove({ user: req.user.id })
            .then(() => {
                Person.findOneAndRemove({ _id: req.user.id })
                    .then(() => { res.json({ success: 'user delete successfully' }) })
                    .catch(err => console.log('Error in deleting user person: ' + err));
            })
